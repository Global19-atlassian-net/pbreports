...
- standard design pattern (Singleton)
- function utils (compose)
- adding options to argparse instance
- setup and parsing logging utils
...
def add_debug_parser(p):
    """
    :type p: argparse.ArgumentParser
    """
    p.add_argument('--debug', action='store_true', help="Debug to standard out")
    return p
