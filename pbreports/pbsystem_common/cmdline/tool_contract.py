"""Core Data Model for the ToolContract (TC) and the Resolved ToolContract (RTC)

This is mostly borrowed from pbsmrtpipe and modified.

"""
import json
import logging

from .models import (ToolDriver,
                     ToolContractTask,
                     ToolContract,
