...
def _get_consensus_table_and_attributes(ref_data, reference_entry):
    ...
    atts = []
    atts.append(
        Attribute('mean_contig_length', mean_contig_length, 'Average Reference Length'))
    atts.append(Attribute('weighted_mean_bases_called',
                          mean_bases_called, 'Average Reference Bases Called'))
    atts.append(Attribute('weighted_mean_concordance',
                          mean_concord, 'Average Reference Consensus Concordance'))
    atts.append(
        Attribute('weighted_mean_coverage', mean_coverage, 'Average Reference Coverage'))
    atts.append(
        Attribute('longest_contig_name', ordered_ids[0], 'Longest Reference Contig'))
