...
def produce_report(
    ...
    attrs.append(Attribute('raw_mean', int(round(raw_mean)), name="Raw Read Length Mean"))
    ...
    attrs.append(Attribute('seed_mean', int(round(seed_mean)), name="Seed Read Length Mean"))
    ...
    attrs.append(Attribute('preassembled_mean', int(round(preassembled_mean)), name="Pre-Assembled Read Length Mean"))
    ...
    attrs.append(Attribute('preassembled_coverage', int(round(preassembled_coverage)), name="Pre-Assembled Coverage (bases/genome_size)"))
