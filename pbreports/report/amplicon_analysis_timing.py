...
def parse_log_file( log_file ):
    ...
    with open( log_file ) as handle:
        ...
        for line in handle:
            ...
            line_time = datetime.datetime.strptime(datetime_part, LOG_TIME_FORMAT)
    ...
    # Compute and return the difference between the min and max time for each barcode
    time_extents = {}
...
def create_table( timings ):
    ...
    t = Table("result_table", title="Amplicon Analysis Timing Summary", columns=columns)
