...
class TestIntervalTree(unittest.TestCase):
    ...
    def test_random_intervals(self):
        ...
        for case in xrange(n_cases):
            ...
            test_region_starts = random.sample(
                range(full_interval_size), n_regions_to_test)
            for test_region_start in test_region_starts:
                test_region_length = random.randrange(
                    full_interval_size - test_region_start)
                ...
                itree.find_overlapping(
                    test_region_start, test_region_end, itree_overlapping_intervals)
